...
class EsonVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by EsonParser#expr.
    def visitExpr(self, ctx:EsonParser.ExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsonParser#term.
    def visitTerm(self, ctx:EsonParser.TermContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsonParser#factor.
    def visitFactor(self, ctx:EsonParser.FactorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsonParser#primary.
