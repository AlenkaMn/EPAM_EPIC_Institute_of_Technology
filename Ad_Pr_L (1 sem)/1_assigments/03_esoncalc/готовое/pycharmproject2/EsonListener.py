...
class EsonListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by EsonParser#expr.
    def enterExpr(self, ctx:EsonParser.ExprContext):
        pass

    # Exit a parse tree produced by EsonParser#expr.
    def exitExpr(self, ctx:EsonParser.ExprContext):
        pass


    # Enter a parse tree produced by EsonParser#term.
    def enterTerm(self, ctx:EsonParser.TermContext):
        pass

    # Exit a parse tree produced by EsonParser#term.
    def exitTerm(self, ctx:EsonParser.TermContext):
        pass


    # Enter a parse tree produced by EsonParser#factor.
    def enterFactor(self, ctx:EsonParser.FactorContext):
        pass

    # Exit a parse tree produced by EsonParser#factor.
    def exitFactor(self, ctx:EsonParser.FactorContext):
        pass


    # Enter a parse tree produced by EsonParser#primary.
    def enterPrimary(self, ctx:EsonParser.PrimaryContext):
        pass

    # Exit a parse tree produced by EsonParser#primary.
    def exitPrimary(self, ctx:EsonParser.PrimaryContext):
        pass
